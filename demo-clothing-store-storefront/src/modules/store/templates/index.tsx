...
const StoreTemplate = ({
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-white to-slate-5">
      <div className="content-container py-8 small:py-12">
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-3xl small:text-4xl font-bold text-slate-90 mb-3" data-testid="store-page-title">
            {search
        ...
        <div className="flex flex-col small:flex-row gap-8">
          ...
          <div className="w-full small:w-64 flex-shrink-0">
            <div className="sticky top-20 bg-white rounded-lg p-6 border border-slate-20">
